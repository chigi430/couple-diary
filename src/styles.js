...
export const S = {
  ...
  headerPeople: { display: "flex", alignItems: "center", flexShrink: 0 },
  headerAvatarBtn: { border: "none", background: "none", padding: 0, cursor: "pointer", lineHeight: 0, borderRadius: "50%" },
  headerAvatarImg: { border: "2px solid var(--bg1)", boxShadow: "0 2px 6px rgba(122,74,60,0.14)" },
  ...
  photoByAv: { position: "absolute", right: 6, bottom: 6, lineHeight: 0, borderRadius: "50%", boxShadow: "0 1px 5px rgba(0,0,0,0.4)" },
  photoByAvSm: { position: "absolute", right: 3, bottom: 3, lineHeight: 0, borderRadius: "50%", boxShadow: "0 1px 4px rgba(0,0,0,0.4)" },
  placeSearchRow: { display: "flex", gap: 6, marginBottom: 6 },
  placeSearchInput: { flex: 1, minWidth: 0, border: "1px solid var(--border)", background: "var(--soft)", borderRadius: 9, padding: "8px 10px", fontSize: 13, color: "var(--text-strong)", outline: "none" },
  placeSearchBtn: { flexShrink: 0, border: "none", background: "#D98763", color: "#fff", borderRadius: 9, padding: "0 14px", fontSize: 13, fontWeight: 700, cursor: "pointer" },
  placeSearchResults: { maxHeight: 168, overflowY: "auto", border: "1px solid var(--border)", borderRadius: 10, marginBottom: 6, background: "var(--card)" },
  placeSearchItem: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 2, width: "100%", textAlign: "left", border: "none", borderBottom: "1px solid var(--border)", background: "none", padding: "8px 10px", cursor: "pointer" },
  placeSearchName: { fontSize: 13, fontWeight: 700, color: "var(--text-h2)" },
  placeSearchAddr: { fontSize: 11.5, color: "var(--text-muted)" },
  placeSearchEmpty: { padding: 10, fontSize: 12.5, color: "var(--text-muted)", textAlign: "center" },
  ...
  placeChips: { display: "flex", flexWrap: "wrap", gap: 5, padding: "7px 9px", background: "var(--soft)" },
  placeChip: { display: "inline-flex", alignItems: "center", gap: 3, fontSize: 11.5, background: "var(--card)", color: "var(--text-chip)", border: "1px solid var(--border)", borderRadius: 8, padding: "3px 8px" },
  placeChipEditable: { display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11.5, background: "var(--card)", color: "var(--text-h2)", border: "1px solid var(--border)", borderRadius: 8, padding: "3px 4px 3px 8px" },
  placeChipX: { border: "none", background: "var(--soft2)", color: "var(--text-muted2)", width: 16, height: 16, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", padding: 0 },
  ...
  profileViewLink: { border: "none", background: "none", padding: 0, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center" },
  profileViewHint: { fontSize: 11.5, fontWeight: 700, color: "var(--text-accent)", marginLeft: 3 },
  partnerRow: { width: "100%", display: "flex", alignItems: "center", gap: 12, background: "var(--card)", border: "none", borderRadius: 16, padding: "13px 15px", marginBottom: 11, boxShadow: "0 6px 18px rgba(122,74,60,0.08)", cursor: "pointer" },
  partnerRowName: { fontSize: 14.5, fontWeight: 800, color: "var(--text-h1)" },
  partnerRowSub: { fontSize: 12, color: "var(--text-muted)", marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  partnerRowChevron: { fontSize: 18, color: "var(--text-muted2)", flexShrink: 0 },
  ...
  // 오류 제보
  reportRow: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 },
  reportBadgeDot: { display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: 17, height: 17, borderRadius: 9, background: "#D9679A", color: "#fff", fontSize: 10.5, fontWeight: 800, padding: "0 5px" },
  reportPhotoBtn: { display: "flex", alignItems: "center", gap: 6, border: "1px dashed var(--border)", borderRadius: 11, background: "var(--soft)", color: "var(--text-muted)", fontSize: 12.5, padding: "9px 12px", cursor: "pointer", marginTop: 8 },
  reportPhotoPreview: { width: "100%", maxHeight: 160, objectFit: "cover", borderRadius: 11, marginTop: 8 },
  reportList: { display: "flex", flexDirection: "column", gap: 8, marginTop: 18 },
  reportItem: { background: "var(--soft)", borderRadius: 12, padding: "10px 11px" },
  reportItemHead: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, marginBottom: 4 },
  reportDesc: { fontSize: 13, color: "var(--text-h2)", lineHeight: 1.5, overflowWrap: "break-word" },
  reportStatus: { fontSize: 10.5, fontWeight: 800, padding: "2px 8px", borderRadius: 8, whiteSpace: "nowrap", flexShrink: 0 },
  reportStatusOpen: { background: "var(--danger-bg)", color: "#C0392B" },
  reportStatusPending: { background: "rgba(217,135,99,0.18)", color: "#C96F5B" },
  reportStatusFixed: { background: "rgba(93,163,120,0.18)", color: "#3D8A5C" },
  reportStatusWontfix: { background: "var(--border)", color: "var(--text-muted2)" },
  reportNote: { fontSize: 12, color: "var(--text-muted)", marginTop: 4, lineHeight: 1.5 },
  reportPhotoThumb: { width: "100%", maxHeight: 140, objectFit: "cover", borderRadius: 9, marginTop: 6 },
  reportDecideRow: { display: "flex", gap: 8, marginTop: 9 },
  reportDeployBtn: { flex: 1, border: "none", borderRadius: 9, background: "linear-gradient(135deg,#E0906C 0%, #C96F5B 100%)", color: "#fff", fontSize: 12.5, fontWeight: 800, padding: "8px", cursor: "pointer" },
  reportWaitBtn: { flex: 1, border: "1px solid var(--border)", borderRadius: 9, background: "var(--card)", color: "var(--text-muted)", fontSize: 12.5, fontWeight: 700, padding: "8px", cursor: "pointer" },
};
