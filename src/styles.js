...
export const S = {
  ...
  sheetHandle: { width: 36, height: 4, borderRadius: 4, background: "var(--border)", margin: "5px auto 12px" },
  ...
  carouselSlide: { flex: "0 0 100%", scrollSnapAlign: "start", position: "relative", aspectRatio: "1", background: "var(--soft2)" },
  ...
  // 설정 탭
  profileDetailCard: { background: "var(--card)", borderRadius: 20, padding: "26px 16px 20px", marginBottom: 11, boxShadow: "0 10px 28px rgba(122,74,60,0.09)", display: "flex", flexDirection: "column", alignItems: "center" },
  ...
  settingsTopRow: { display: "flex", justifyContent: "flex-end", marginBottom: 8 },
};
